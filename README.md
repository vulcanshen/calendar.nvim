# calendar.nvim
  ...
  A minimal calendar widget for Neovim that embeds below the [Snacks.nvim](https://github.com/folke/snacks.nvim) explorer sidebar, showing a monthly
  calendar with today highlighted and a live clock with blinking colon.
